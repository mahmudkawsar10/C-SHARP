...
namespace WindowsFormsApplication1
{
    public partial class Form4 : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "data source = DESKTOP-M2GE7BU;" +
                                   "database = coffeshop;" +
            ...
            con10.ConnectionString = "data source = DESKTOP-M2GE7BU;" +
                                   "database = coffeshop;" +
                                   "integrated security = SSPI";
        ...
        private void additem_Click(object sender, EventArgs e)
        {
            ...
            //ConnectionString:
            con.ConnectionString = "data source = DESKTOP-M2GE7BU;database = coffeshop;integrated security = SSPI";
            ...
            using (SqlCommand cmd = new SqlCommand(sql, con))
            {
               ...
               cmd.CommandType = CommandType.Text;
                ...
                selldetailsgridview.DataSource = "data source = DESKTOP-M2GE7BU;database = coffeshop;integrated security = SSPI";
